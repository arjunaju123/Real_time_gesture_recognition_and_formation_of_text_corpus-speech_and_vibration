...
for ele in range(0,len(lst)):
    ...
    for sample_img in os.listdir(f"C:\\Users\\54721\\OneDrive\\Desktop\\ASL_realtime\\asl_alphabet_train\\asl_alphabet_train\\{lst[ele]}"):
        ...
        if hands:
            ...
            # print("ele is",ele)
            if not os.path.exists(f"C:\\Users\\54721\\OneDrive\\Desktop\\ASL_realtime\\crop_full\\{lst[ele]}"):
      
                os.makedirs(f"C:\\Users\\54721\\OneDrive\\Desktop\\ASL_realtime\\crop_full\\{lst[ele]}")
